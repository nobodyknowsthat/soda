...
#ifdef USE_UNVME
	unvme_init_driver(8, "2", "0000:01:00.0");
#endif

#ifdef USE_STORPU
	storpu_create_context("/home/jimx/projects/storpu/build/lib/libtest.so");
#endif
...
PostmasterStateMachine(void)
{
	...
	{
#ifdef USE_STORPU
		storpu_destroy_context();
#endif

#ifdef USE_UNVME
		unvme_shutdown_driver();
#endif
